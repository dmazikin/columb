        ...
        <div class="excursion-card-top">
            ...
            <div class="excursion-card-right">
                ...
                <div class="card-button-wrapper">
                    <button class="card-button open-cart-popup" data-product_name="<?php echo esc_attr($product->get_title()); ?>" data-product_id="<?php echo esc_attr($product->get_id()); ?>" data-product_price="<?php echo esc_attr($product->get_price()); ?>" data-travel_date="<?php echo esc_attr(get_field('travel_date')); ?>" data-count_adult="<?php echo esc_attr(get_field('count_adult')); ?>" data-count_child="<?php echo esc_attr(get_field('count_child')); ?>" data-dop_charges="<?php echo esc_attr(get_field('dop_charges')); ?>">
            ...
            <?php if (get_field('category_primechanie', $product->get_id())) : ?>
                <div class="excursion-card-table excursion-card-warrning">
                    <div class="excursion-card-table-col">
